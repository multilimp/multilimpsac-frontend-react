      ...
      form.setFieldsValue({
        ...
        transportes: orderData.transportesAsignados
          ...
          .map(transporte => ({
            ...
            montoFletePagado: transporte.montoFletePagado ?? null,
            numeroFactura: transporte.numeroFactura || '',
            archivoFactura: transporte.archivoFactura || null,
            numeroGrt: transporte.grt || '',
            archivoGrt: transporte.guiaRemision || null,
