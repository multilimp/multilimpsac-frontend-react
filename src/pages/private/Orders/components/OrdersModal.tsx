...
import { createOrder, updateOrder } from '@/services/orders/orders.request';
    ...
    >
      ...
      <DialogContent>
        <Spin spinning={loading}>
          <Form form={form} layout="vertical" onFinish={handleSubmit} style={{ marginTop: 8 }} autoComplete="off">
            <Grid container spacing={2}>
              ...
              <Grid size={{ xs: 12, sm: 6, md: 4 }}>
                <Form.Item name="razonSocialCliente" rules={required('Ingrese razón social cliente')}>
              ...
              <Grid size={{ xs: 12, sm: 6, md: 4 }}>
                <Form.Item name="razonSocialEmpresa" rules={required('Ingrese razón social empresa')}>
              ...
              <Grid size={{ xs: 12, sm: 6, md: 4 }}>
                <Form.Item name="fechaRegistro" rules={required('Seleccione fecha de registro')}>
                  <InputAntd label="Fecha registro" type="date" />
                </Form.Item>
              </Grid>
              <Grid size={{ xs: 12, sm: 6, md: 4 }}>
                <Form.Item name="fechaMaximaEntrega" rules={required('Seleccione fecha máxima entrega')}>
              ...
              <Grid size={{ xs: 12, sm: 6, md: 4 }}>
                <Form.Item name="fechaEntregaOC" rules={required('Seleccione fecha de entrega OC')}>
